							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("a", {
										href: "/login",
										className: "text-sm font-semibold text-gray-300 hover:text-white transition-colors decoration-transparent",
										children: "Log In"
									}), /* @__PURE__ */ jsx("a", {
										href: "/register",
										className: "btn-amber px-5 py-2 transition-transform hover:scale-105 text-sm",
										children: "Register"
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("a", {
										href: "/register",
										className: "btn-amber px-4 py-1.5 text-sm transition-transform hover:scale-105",
										children: "Register"
									}), /* @__PURE__ */ jsx("button", {
					...
					isMenuOpen && /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: navLinks.map((link) => /* @__PURE__ */ jsx("a", {
								href: getHref(link.page),
								onClick: (e) => handleNavClick(e, link.page),
								className: "text-left text-gray-400 hover:text-white font-bold text-sm py-2 block decoration-transparent",
								children: link.label
							}, link.page))
						}), /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("a", {
								href: "/login",
								className: "text-center text-gray-300 hover:text-white font-bold text-sm py-2 block decoration-transparent w-full",
								children: "Log In"
							})
						})]
					})
...
function BlogFooter() {
	...
	return /* @__PURE__ */ jsxs("footer", {
		className: "relative bg-slate-900 text-slate-300 pt-16 pb-10 overflow-hidden mt-12 w-full border-t border-slate-800",
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: [
										...
										className: "w-10 h-10 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-blue-600 hover:border-blue-500 transition-all duration-300 shadow-sm hover:shadow-blue-500/20 hover:-translate-y-1",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("h3", {
								...
								children: [/* @__PURE__ */ jsx("p", {
									className: "text-sm text-slate-400 leading-relaxed m-0",
					...
					children: [/* @__PURE__ */ jsxs("p", {
						className: "text-sm text-slate-500 font-medium m-0",
						children: [
							"© ",
						...
						children: /* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2 text-sm text-slate-500 bg-slate-800/50 px-3 py-1.5 rounded-full border border-slate-700",
...
//#endregion
export { Navbar as n, BlogFooter as t };
