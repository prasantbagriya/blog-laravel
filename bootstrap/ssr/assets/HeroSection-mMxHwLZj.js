...
var HeroSection = ({ onSearchSubmit, onOpenAiAssistant, categories, onSelectCategory, trendingBusinesses, onSelectBusiness }) => {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				className: "relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24",
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("h1", {
								className: "text-4xl sm:text-5xl lg:text-6xl xl:text-[4rem] font-extrabold leading-[1.1] text-white tracking-tight",
								children: [
									"Read Reviews. ",
							...
							/* @__PURE__ */ jsxs("form", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									className: "relative flex items-center gap-2 rounded-full bg-white p-2 shadow-lg w-full z-20",
									children: [
										...
										/* @__PURE__ */ jsxs("button", {
											...
											children: [/* @__PURE__ */ jsx(Sparkles, { className: "w-4 h-4 text-blue-600" }), /* @__PURE__ */ jsx("span", { children: "Ask AI" })]
										}),
										/* @__PURE__ */ jsx("button", {
											type: "submit",
