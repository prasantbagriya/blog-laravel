...
import { BusinessProfileView } from "./BusinessProfileView-Cjhu01Yw.js";
...
*/
var SubmitReviewModal = React.lazy(() => import("./SubmitReviewModal-BbCZmBUU.js").then((module) => ({ default: module.SubmitReviewModal })));
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: business?.faqs && business.faqs.length > 0 ? `Answers to common questions about ${business.name} and their services.` : `Everything you need to know about our verified business directory, reviews, and Trust Scores.`
						})
					] }), /* @__PURE__ */ jsxs("div", {
...
function App({ initialView = "home", initialCategorySlug = "all", businessData = null }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [activeView === "profile" && viewedBusiness ? /* @__PURE__ */ jsx(SeoMeta, { meta: {
		...
		className: "trustpulse-app min-h-screen flex flex-col font-sans transition-colors bg-white text-zinc-900 dark:bg-zinc-950 dark:text-white",
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(Suspense, {
					fallback: null,
					children: [showSearchModal && /* @__PURE__ */ jsx(AiSearchModal, {
				...
				/* @__PURE__ */ jsx(ReviewsFAQ, { business: viewedBusiness }),
