...
import DeleteUserForm from "./DeleteUserForm-C1SXtG3w.js";
import UpdatePasswordForm from "./UpdatePasswordForm-ZqjB2oSu.js";
import UpdateProfileInformation from "./UpdateProfileInformationForm-B8U9BQfc.js";
...
function AuthenticatedLayout({ header, children }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen bg-[#FDFCFB] dark:bg-[#0F0F0E] text-[#1A1A1A] dark:text-white transition-colors",
		children: [
			/* @__PURE__ */ jsxs("nav", {
				className: "border-b border-[#E5E5E1] dark:border-[#2A2A28] bg-white dark:bg-[#161615] sticky top-0 z-40",
				children: [/* @__PURE__ */ jsx("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(Link, {
										...
										children: /* @__PURE__ */ jsx(ApplicationLogo, { className: "block h-9 w-auto fill-current text-[#1A1A1A] dark:text-white" })
									})
								}), /* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsx(NavLink, {
										...
										className: "text-[#555555] dark:text-[#A0A09C] hover:text-[#1A1A1A] dark:hover:text-white",
										children: "Dashboard"
									})
								})]
							}),
								...
								children: /* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsxs(Dropdown, { children: [/* @__PURE__ */ jsx(Dropdown.Trigger, { children: /* @__PURE__ */ jsx("span", {
										...
										children: /* @__PURE__ */ jsxs("button", {
											type: "button",
											className: "inline-flex items-center rounded-md border border-transparent bg-transparent px-3 py-2 text-sm font-semibold leading-4 text-[#1A1A1A] dark:text-white hover:bg-[#F5F5F2] dark:hover:bg-[#2A2A28] transition duration-150 ease-in-out focus:outline-none",
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx("button", {
									...
									className: "inline-flex items-center justify-center rounded-md p-2 text-[#555555] dark:text-[#A0A09C] transition duration-150 ease-in-out hover:bg-[#F5F5F2] dark:hover:bg-[#2A2A28] focus:outline-none",
					...
					className: (showingNavigationDropdown ? "block" : "hidden") + " sm:hidden bg-white dark:bg-[#161615] border-t border-[#E5E5E1] dark:border-[#2A2A28]",
					children: [/* @__PURE__ */ jsx("div", {
						...
						className: "border-t border-[#E5E5E1] dark:border-[#2A2A28] pb-1 pt-4",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "px-4",
							children: [/* @__PURE__ */ jsx("div", {
								className: "text-base font-medium text-[#1A1A1A] dark:text-white",
								children: user.name
							}), /* @__PURE__ */ jsx("div", {
								className: "text-sm font-medium text-[#555555] dark:text-[#A0A09C]",
								children: user.email
							})]
						}), /* @__PURE__ */ jsxs("div", {
			...
			header && /* @__PURE__ */ jsx("header", {
				className: "bg-white dark:bg-[#161615] border-b border-[#E5E5E1] dark:border-[#2A2A28]",
				children: /* @__PURE__ */ jsx("div", {
...
function Edit({ mustVerifyEmail, status }) {
	return /* @__PURE__ */ jsxs(AuthenticatedLayout, {
		header: /* @__PURE__ */ jsx("h2", {
			className: "text-xl font-bold leading-tight text-[#1A1A1A] dark:text-white",
			children: "Profile Settings"
		}),
		children: [/* @__PURE__ */ jsx(Head, { title: "Profile Settings" }), /* @__PURE__ */ jsx("div", {
			className: "py-12 bg-[#FDFCFB] dark:bg-[#0F0F0E]",
			children: /* @__PURE__ */ jsxs("div", {
				className: "mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8",
				children: [
					/* @__PURE__ */ jsx("div", {
						className: "bg-white dark:bg-[#161615] p-4 shadow-sm sm:rounded-xl sm:p-8 border border-[#E5E5E1] dark:border-[#2A2A28]",
