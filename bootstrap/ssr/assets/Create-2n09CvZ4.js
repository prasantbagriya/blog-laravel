...
import { AlignCenter, AlignLeft, AlignRight, Bold, CheckCircle2, Heading1, Heading2, Image as Image$1, Italic, Link as Link$2, List, ListOrdered, PencilLine, Quote, Strikethrough, Underline as Underline$1, Video } from "lucide-react";
...
function CreatePost({ auth, communities, default_community_id, editPost }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-zinc-100 font-sans pb-20 transition-colors",
		children: [
			/* @__PURE__ */ jsx(Head, { title: isEdit ? "Edit Post" : "Create a Post" }),
			/* @__PURE__ */ jsx(Navbar, { auth }),
			/* @__PURE__ */ jsxs("div", {
				className: "w-full max-w-6xl mx-auto pt-8 px-4 flex gap-8",
				children: [/* @__PURE__ */ jsxs("div", {
					className: "flex-1",
					children: [
						/* @__PURE__ */ jsx("h1", {
							className: "text-xl font-bold text-slate-900 dark:text-white border-b border-slate-200 dark:border-zinc-800 pb-4 mb-6",
							children: isEdit ? "Edit post" : "Create a post"
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "mb-6 relative w-72",
							children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex border-b border-slate-200 dark:border-zinc-800 bg-slate-50 dark:bg-zinc-900/50",
								children: [
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												/* @__PURE__ */ jsxs("div", {
													className: "absolute right-4 top-3.5 text-xs text-slate-400 font-medium",
										...
										data.type === "MEDIA" && /* @__PURE__ */ jsxs("div", {
											className: "mb-5",
											children: [/* @__PURE__ */ jsxs("div", {
												className: "border-2 border-dashed border-slate-300 dark:border-zinc-700 bg-slate-50 dark:bg-zinc-950 rounded-2xl p-12 flex flex-col items-center justify-center gap-4 transition-colors",
												children: [/* @__PURE__ */ jsx("input", {
													...
													htmlFor: "media_file",
													className: "px-6 py-2.5 border-2 border-blue-600 text-blue-600 dark:text-blue-400 dark:border-blue-500 font-bold rounded-full hover:bg-blue-50 dark:hover:bg-blue-900/20 cursor-pointer transition-colors shadow-sm",
										...
										/* @__PURE__ */ jsx("div", {
											className: "flex justify-end border-t border-slate-100 dark:border-zinc-800 pt-5 mt-2",
					...
					children: /* @__PURE__ */ jsxs("div", {
						className: "bg-white dark:bg-zinc-900 rounded-2xl border border-slate-200 dark:border-zinc-800 p-5 mb-4 shadow-sm",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3 mb-4",
							children: [/* @__PURE__ */ jsx("div", {
								className: "w-10 h-10 bg-amber-100 dark:bg-amber-900/30 rounded-xl flex items-center justify-center text-amber-600 dark:text-amber-500",
								children: /* @__PURE__ */ jsx(ListOrdered, { size: 20 })
							}), /* @__PURE__ */ jsx("h2", {
								className: "font-bold text-slate-900 dark:text-white text-base",
								children: "Community Rules"
							})]
						}), /* @__PURE__ */ jsxs("ul", {
							className: "text-sm text-slate-600 dark:text-zinc-400 font-medium space-y-3 pt-3 border-t border-slate-100 dark:border-zinc-800",
							children: [
								/* @__PURE__ */ jsxs("li", {
									className: "flex items-start gap-2 border-b border-slate-50 dark:border-zinc-800/50 pb-3",
									children: [/* @__PURE__ */ jsx(CheckCircle2, {
										size: 16,
										className: "text-blue-500 mt-0.5 shrink-0"
									}), /* @__PURE__ */ jsx("span", { children: "Remember the human" })]
								}),
								/* @__PURE__ */ jsxs("li", {
									className: "flex items-start gap-2 border-b border-slate-50 dark:border-zinc-800/50 pb-3",
									children: [/* @__PURE__ */ jsx(CheckCircle2, {
										size: 16,
										className: "text-blue-500 mt-0.5 shrink-0"
									}), /* @__PURE__ */ jsx("span", { children: "Behave like you would in real life" })]
								}),
								/* @__PURE__ */ jsxs("li", {
									className: "flex items-start gap-2 border-b border-slate-50 dark:border-zinc-800/50 pb-3",
									children: [/* @__PURE__ */ jsx(CheckCircle2, {
										size: 16,
										className: "text-blue-500 mt-0.5 shrink-0"
									}), /* @__PURE__ */ jsx("span", { children: "Look for the original source of content" })]
								}),
								/* @__PURE__ */ jsxs("li", {
									className: "flex items-start gap-2 border-b border-slate-50 dark:border-zinc-800/50 pb-3",
									children: [/* @__PURE__ */ jsx(CheckCircle2, {
										size: 16,
										className: "text-blue-500 mt-0.5 shrink-0"
									}), /* @__PURE__ */ jsx("span", { children: "Search for duplicates before posting" })]
								}),
								/* @__PURE__ */ jsxs("li", {
									...
									children: [/* @__PURE__ */ jsx(CheckCircle2, {
										size: 16,
										className: "text-blue-500 mt-0.5 shrink-0"
									}), /* @__PURE__ */ jsx("span", { children: "Read the community's rules" })]
								})
							]
						})]
					})
