...
var HomeHero = ({ activeSlides, basePath, categories, featuredBusinesses }) => {
	...
	const validSlides = activeSlides && activeSlides.length > 0 ? activeSlides : [{ image_url: "/uploads/background.webp" }];
	useEffect(() => {
...
function Welcome(props) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs(Head, { children: [(!sliders || sliders.length === 0) && /* @__PURE__ */ jsx("link", {
				rel: "preload",
				as: "image",
				href: "/uploads/background.webp"
			}), sliders && sliders.length > 0 && /* @__PURE__ */ jsx("link", {
				rel: "preload",
				as: "image",
				href: typeof sliders[0] === "string" ? sliders[0] : sliders[0].image_url || sliders[0].image || sliders[0].coverImage
			})] }),
			/* @__PURE__ */ jsx(Navbar, {}),
