...
import { CircleDot, Flame, Plus, Shield, Sparkle, TrendingUp, Users } from "lucide-react";
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs(Link, {
							...
							className: "bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-2xl p-4 flex gap-4 items-center cursor-text mb-6 shadow-sm hover:shadow-md transition-shadow group",
							children: [
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsx("div", {
									className: "w-10 h-10 rounded-xl bg-slate-50 dark:bg-zinc-800 text-slate-500 dark:text-zinc-400 flex items-center justify-center group-hover:bg-blue-50 dark:group-hover:bg-blue-500/10 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors",
