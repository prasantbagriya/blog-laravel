	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs(Head, { children: [
				/* @__PURE__ */ jsx("title", { children: "CoachingsinSikar | Content Creation & Editorial Policy" }),
				/* @__PURE__ */ jsx("meta", {
					name: "description",
					content: "Learn how CoachingsinSikar creates and maintains content, including editorial standards, research, sourcing, updates, transparency, and corrections."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "keywords",
					content: "Content creation policy, editorial quality, research and sources, editorial policy CoachingsinSikar, content standards education blog Sikar, coaching guides Sikar content review, fact-checking process coachingsinsikar.com, CoachingsinSikar content policy, Sikar coaching editorial principles, editorial transparency, reliable education content, content publishing policy, research and sourcing policy"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:title",
					content: "CoachingsinSikar | Content Creation & Editorial Policy"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:description",
					content: "Our editorial policy explains how CoachingsinSikar researches, writes, and updates articles on coachings, schools, and education in Sikar, with a focus on accuracy and honesty."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:title",
					content: "Content & Editorial Policy of CoachingsinSikar"
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:description",
					content: "Read how CoachingsinSikar maintains editorial quality. This page covers our standards, fact‑checking, update process, accuracy policy for coaching reviews, transparency in coaching coverage, and commitment to honest, local education information."
				})
			] }),
			/* @__PURE__ */ jsx(Navbar, {}),
			/* @__PURE__ */ jsxs("main", {
