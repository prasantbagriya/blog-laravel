...
var HeroSection = ({ onSearchSubmit, onOpenAiAssistant, categories, onSelectCategory, trendingBusinesses, onSelectBusiness }) => {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				className: "relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 md:pt-40 md:pb-24",
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("h1", {
								className: "text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-extrabold leading-[1.05] text-white tracking-tight mt-4",
								children: [
									"Read Reviews. ",
