...
var ReportModal_exports = /* @__PURE__ */ __exportAll({ default: () => ReportModal });
function ReportModal({ isOpen, onClose, reportableId, reportableType }) {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			className: "bg-white dark:bg-zinc-900 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200",
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						className: "w-10 h-10 rounded-full bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 flex items-center justify-center",
						children: /* @__PURE__ */ jsx(Flag, { size: 20 })
					}), /* @__PURE__ */ jsx("h2", {
				...
				children: [
					/* @__PURE__ */ jsx("p", {
						className: "text-[15px] font-bold text-slate-700 dark:text-zinc-300 mb-4",
						children: "Why are you reporting this?"
					}),
					/* @__PURE__ */ jsx("div", {
						className: "space-y-2 mb-6",
						children: reasons.map((r, i) => /* @__PURE__ */ jsxs("label", {
							className: `flex items-center gap-3 cursor-pointer p-3 rounded-2xl transition-all border ${reason === r ? "border-rose-500 bg-rose-50 dark:bg-rose-900/20" : "border-transparent hover:bg-slate-50 dark:hover:bg-zinc-800"}`,
							children: [/* @__PURE__ */ jsx("input", {
								...
								className: `text-[15px] font-semibold ${reason === r ? "text-rose-700 dark:text-rose-400" : "text-slate-700 dark:text-zinc-300"}`,
								children: r
							})]
						}, i))
					}),
					reason === "Other" && /* @__PURE__ */ jsxs("div", {
						className: "mb-6 animate-in slide-in-from-top-2 fade-in duration-200",
					...
					/* @__PURE__ */ jsxs("div", {
						className: "flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-zinc-800",
...
//#endregion
export { ReportModal_exports as n, ReportModal as t };
