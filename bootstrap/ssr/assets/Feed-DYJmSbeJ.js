...
import { Compass, Flame, Home, Plus, Search, Sparkle, Sparkles, TrendingUp } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs(Head, { children: [
				/* @__PURE__ */ jsx("title", { children: "Community Feed of CoachingsinSikar" }),
				/* @__PURE__ */ jsx("meta", {
					name: "description",
					content: "Stay updated with new guides, comparisons, and updates on coaching and schools in Sikar through the CoachingsinSikar community feed."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "keywords",
					content: "CoachingsinSikar community, Sikar education community, coaching community Sikar feed, students community Sikar, education discussions Sikar, coaching discussions Sikar, Sikar student community"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:type",
					content: "website"
				...
				/* @__PURE__ */ jsx("meta", {
					property: "og:title",
					content: "Community Feed of CoachingsinSikar"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:description",
					content: "Follow the CoachingsinSikar feed to get every new article on JEE, NEET, CA, CLAT, and schools in Sikar as soon as it’s published."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:card",
				...
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:title",
					content: "CoachingsinSikar Community Feed"
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:description",
					content: "Use this feed to follow all new coaching and school guides from CoachingsinSikar, delivered straight to your reader or app."
				}),
				/* @__PURE__ */ jsx("link", {
					rel: "canonical",
					href: currentUrl
			...
			/* @__PURE__ */ jsxs("div", {
				className: "max-w-[1400px] w-full mx-auto pt-32 px-4 sm:px-6 flex gap-8",
				children: [
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs(Link, {
									...
									className: `flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all ${currentFilter === "popular" ? "bg-white dark:bg-zinc-900 text-slate-900 dark:text-white shadow-sm border border-slate-200 dark:border-zinc-800 font-bold" : "text-slate-600 dark:text-zinc-400 hover:bg-white dark:hover:bg-zinc-900 hover:shadow-sm hover:text-slate-900 dark:hover:text-white border border-transparent hover:border-slate-200 dark:hover:border-zinc-800"}`,
									children: [/* @__PURE__ */ jsx(Compass, {
										size: 20,
										strokeWidth: currentFilter === "popular" ? 2.5 : 2,
										className: currentFilter === "popular" ? "text-amber-500 flex-shrink-0" : "text-slate-400 dark:text-zinc-500 flex-shrink-0"
									}), /* @__PURE__ */ jsx("span", {
										className: isSidebarCollapsed ? "lg:hidden" : "",
										children: "Popular"
									})]
								...
								auth?.joined_communities && auth.joined_communities.length > 0 && /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										...
										className: "flex items-center gap-3 px-4 py-2.5 rounded-xl text-slate-600 dark:text-zinc-300 hover:bg-white dark:hover:bg-zinc-900 hover:shadow-sm hover:text-slate-900 dark:hover:text-white font-medium transition-all border border-transparent hover:border-slate-200 dark:hover:border-zinc-800",
										children: [community.icon_image ? /* @__PURE__ */ jsx("img", {
											...
											className: `truncate font-semibold text-sm ${isSidebarCollapsed ? "lg:hidden" : ""}`,
						...
						children: [
							/* @__PURE__ */ jsxs("form", {
								...
								children: [/* @__PURE__ */ jsx("button", {
									...
									className: "relative flex-1 flex items-center gap-2 rounded-full bg-white dark:bg-zinc-900 p-2 border border-slate-200 dark:border-zinc-800 z-20 group transition-all duration-200 focus-within:border-blue-500 dark:focus-within:border-blue-500 focus-within:shadow-[0_0_0_3px_rgba(59,130,246,0.15)] hover:border-blue-400 dark:hover:border-blue-600",
									children: [
										...
										/* @__PURE__ */ jsx("button", {
											type: "submit",
											className: "bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full px-6 py-2.5 transition-colors shrink-0 border-none outline-none focus:outline-none ring-0 focus:ring-0 text-sm md:text-base",
											children: "Search"
										})
									]
								})]
							...
							nextPageUrl && /* @__PURE__ */ jsx("div", {
								...
								children: loadingMore ? /* @__PURE__ */ jsx("div", { className: "w-10 h-10 border-4 border-blue-600 dark:border-blue-500 border-t-transparent rounded-full animate-spin shadow-sm" }) : /* @__PURE__ */ jsx("div", {
									className: "text-[14px] text-slate-500 dark:text-zinc-400 font-bold bg-white dark:bg-zinc-900 px-6 py-2 rounded-full border border-slate-200 dark:border-zinc-800 shadow-sm",
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									className: "h-16 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 relative overflow-hidden",
									children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-20" })
								}), /* @__PURE__ */ jsxs("div", {
									className: "p-6 relative",
									children: [
										/* @__PURE__ */ jsx("div", {
											className: "w-16 h-16 -mt-14 mb-4 bg-white dark:bg-zinc-900 rounded-2xl p-1 shadow-lg flex items-center justify-center relative z-10 mx-auto",
											children: /* @__PURE__ */ jsx("div", {
												className: "w-full h-full bg-blue-50 dark:bg-blue-900/30 rounded-xl flex items-center justify-center border border-blue-100 dark:border-blue-800/50",
												children: /* @__PURE__ */ jsx(Sparkles, { className: "w-7 h-7 text-blue-600 dark:text-blue-400" })
											})
										}),
										/* @__PURE__ */ jsx("h2", {
											className: "font-extrabold text-slate-900 dark:text-white text-xl text-center mb-2",
											children: "Welcome Home"
										}),
										/* @__PURE__ */ jsx("p", {
											className: "text-sm text-slate-500 dark:text-zinc-400 mb-6 leading-relaxed text-center font-medium",
											children: "Your personalized feed. Explore communities, share knowledge, and stay updated on the latest discussions."
										}),
										/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h3", {
									className: "font-extrabold text-slate-900 dark:text-white text-sm uppercase tracking-widest mb-4",
									...
									children: [
										...
										children: [/* @__PURE__ */ jsxs("div", {
											className: "font-bold text-slate-300 dark:text-zinc-700 group-hover:text-blue-500 transition-colors",
											children: ["0", i]
										}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
											className: "font-bold text-sm text-slate-700 dark:text-zinc-300 group-hover:text-slate-900 dark:group-hover:text-white transition-colors leading-tight",
											children: ["Trending Discussion Topic #", i]
										}), /* @__PURE__ */ jsx("div", {
											className: "text-xs font-medium text-slate-500 dark:text-zinc-500 mt-1",
											children: "4.5k Posts"
										})] })]
									}, i))
								})]
