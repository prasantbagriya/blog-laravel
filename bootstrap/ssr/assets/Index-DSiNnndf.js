				...
				children: [
					/* @__PURE__ */ jsx("form", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							className: "relative flex items-center gap-2 rounded-full bg-slate-100 dark:bg-zinc-800/80 p-2 shadow-inner hover:bg-slate-200/60 dark:hover:bg-zinc-800 transition-all focus-within:ring-2 focus-within:ring-blue-500/50",
							children: [
								/* @__PURE__ */ jsx(Search, { className: "w-5 h-5 text-slate-500 dark:text-zinc-400 ml-3 flex-shrink-0" }),
								/* @__PURE__ */ jsx("input", {
									type: "text",
									name: "q",
								...
								/* @__PURE__ */ jsx("button", {
									type: "submit",
									className: "bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full px-6 py-2.5 transition-colors shrink-0",
									children: "Search"
								})
							]
						})
					...
					/* @__PURE__ */ jsxs("div", {
						className: "flex flex-wrap gap-2 mb-8 p-1.5 bg-white dark:bg-zinc-900 rounded-xl border border-slate-200 dark:border-zinc-800 w-fit",
						children: [
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Compass, { size: 16 }), " Institutes"]
							}),
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(MessageSquare, { size: 16 }), " Blogs"]
							}),
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(MessageSquare, { size: 16 }), " Community Posts"]
							}),
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(LayoutGrid, { size: 16 }), " Communities"]
							}),
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Users, { size: 16 }), " People"]
							})
						]
					}),
					/* @__PURE__ */ jsxs("div", {
