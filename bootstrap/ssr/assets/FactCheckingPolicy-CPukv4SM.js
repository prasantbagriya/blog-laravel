	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs(Head, { children: [
				/* @__PURE__ */ jsx("title", { children: "CoachingsinSikar Fact-Checking Standards | Verification & Accuracy" }),
				/* @__PURE__ */ jsx("meta", {
					name: "description",
					content: "Understand the fact-checking standards used by CoachingsinSikar to review claims, verify sources, improve accuracy, and correct published information."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "keywords",
					content: "CoachingsinSikar fact checking policy, how we verify coachingsinsikar.com, correction policy education blog Sikar, accuracy standards coaching guides, fact verification process coachingsinsikar.com, reliable education information Sikar, Fact checking policy CoachingsinSikar, how we verify facts Sikar"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:title",
					content: "CoachingsinSikar Fact-Checking Standards | Verification & Accuracy"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:description",
					content: "This page explains how CoachingsinSikar checks facts, handles corrections, and maintains accuracy in all articles about coaching, schools, and education in Sikar."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:title",
					content: "Fact-Checking Standards of CoachingsinSikar"
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:description",
					content: "See how CoachingsinSikar verifies information. Our fact‑checking policy covers verification steps, corrections, and our commitment to accurate, trustworthy education content"
				})
			] }),
			/* @__PURE__ */ jsx(Navbar, {}),
			/* @__PURE__ */ jsxs("main", {
