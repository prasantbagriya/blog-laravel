...
import { Award, BookOpen, CheckCircle2, ChevronDown, ChevronRight, GraduationCap, MapPin, MessageSquare, PlayCircle, Search, ShieldCheck, Star, TrendingUp } from "lucide-react";
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								post.type === "TEXT" && post.content && /* @__PURE__ */ jsx("p", {
									className: "text-slate-600 dark:text-zinc-400 text-sm line-clamp-2 mb-4 leading-relaxed",
									children: post.content.replace(/<[^>]*>?/gm, "")
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-4 text-slate-500 dark:text-zinc-500 text-sm font-bold",
									children: [/* @__PURE__ */ jsxs("div", {
										className: "flex sm:hidden items-center gap-1.5 bg-slate-100 dark:bg-zinc-800 px-3 py-1.5 rounded-full",
										children: [
										...
										className: "flex items-center gap-1.5 hover:text-blue-600 dark:hover:text-blue-400 transition-colors bg-slate-100 dark:bg-zinc-800 sm:bg-transparent px-3 py-1.5 sm:p-0 rounded-full sm:rounded-none",
										children: [
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("div", {
												...
												className: "text-xs font-bold text-slate-500 dark:text-zinc-500 flex items-center gap-3",
												children: [/* @__PURE__ */ jsxs("span", { children: [community.members_count || community.members, " Members"] }), /* @__PURE__ */ jsxs("span", {
...
var CategorySection = ({ categories, basePath }) => {
	...
	return /* @__PURE__ */ jsx("section", {
		className: "pt-10 pb-2 md:pt-14 md:pb-4 bg-white dark:bg-zinc-950 overflow-hidden",
		children: /* @__PURE__ */ jsxs("div", {
			className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
			children: [/* @__PURE__ */ jsxs("div", {
