				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(Link2, { className: "w-4 h-4 text-slate-400" })
						}),
						/* @__PURE__ */ jsx("input", {
							type: "text",
							readOnly: true,
							value: url,
							className: "w-full pl-9 pr-24 py-3 bg-slate-50 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 text-slate-600 dark:text-zinc-300 text-sm rounded-xl focus:outline-none"
						}),
						/* @__PURE__ */ jsx("button", {
							onClick: handleCopy,
							className: `absolute inset-y-1.5 right-1.5 px-4 rounded-lg font-bold text-xs transition-colors ${copied ? "bg-emerald-500 text-white" : "bg-blue-600 hover:bg-blue-700 text-white"}`,
