			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("main", {
					...
					children: /* @__PURE__ */ jsxs("article", { children: [
						/* @__PURE__ */ jsxs("header", {
							...
							children: [
								post.category && /* @__PURE__ */ jsx(Link, {
									href: `${window.BASE_PATH}/category/${(post.category.toLowerCase() === "eduction" ? "education" : post.category).toLowerCase().replace(/[^a-z0-9]+/g, "-")}`,
									className: "text-blue-600 font-bold uppercase tracking-widest text-sm mb-3 block hover:underline",
									children: post.category.toLowerCase() === "eduction" ? "Education" : post.category
								}),
								/* @__PURE__ */ jsx("h1", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [post.authorImage && /* @__PURE__ */ jsx("img", {
										...
										/* @__PURE__ */ jsx(Link, {
											...
											className: "font-semibold text-lg text-slate-800 hover:text-blue-600 hover:underline",
										...
										post.authorAwards && post.authorAwards.length > 0 && /* @__PURE__ */ jsxs("p", {
											className: "text-xs font-semibold text-amber-600 mt-0.5 flex items-center gap-1",
											children: [
												/* @__PURE__ */ jsxs("svg", {
								...
								post.factCheckedBy && /* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2 mb-8 p-4 bg-emerald-50 border border-emerald-100 rounded-lg text-emerald-800 text-sm",
									children: [/* @__PURE__ */ jsxs("svg", {
										...
										strokeLinecap: "round",
										strokeLinejoin: "round",
										className: "lucide lucide-check-circle-2 text-emerald-600",
										children: [/* @__PURE__ */ jsx("circle", {
											cx: "12",
											cy: "12",
											r: "10"
						...
						/* @__PURE__ */ jsxs("div", {
							className: "flex flex-wrap items-center gap-3 mb-8 border-y border-slate-100 py-4",
							children: [
								/* @__PURE__ */ jsx("span", {
									className: "font-semibold text-slate-700 mr-2",
								...
								/* @__PURE__ */ jsxs("a", {
									...
									className: "flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-sky-50 text-slate-600 hover:text-sky-600 rounded-full text-sm font-medium transition-colors",
								...
								/* @__PURE__ */ jsxs("a", {
									...
									target: "_blank",
									rel: "noopener noreferrer",
									className: "flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-blue-50 text-slate-600 hover:text-blue-600 rounded-full text-sm font-medium transition-colors",
									children: [/* @__PURE__ */ jsx("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										width: "16",
										height: "16",
								...
								/* @__PURE__ */ jsxs("a", {
									...
									target: "_blank",
									rel: "noopener noreferrer",
									className: "flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-blue-50 text-slate-600 hover:text-blue-700 rounded-full text-sm font-medium transition-colors",
									children: [/* @__PURE__ */ jsxs("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										width: "16",
										height: "16",
								...
								/* @__PURE__ */ jsxs("a", {
									...
									target: "_blank",
									rel: "noopener noreferrer",
									className: "flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-green-50 text-slate-600 hover:text-green-600 rounded-full text-sm font-medium transition-colors",
									children: [/* @__PURE__ */ jsx("svg", {
										xmlns: "http://www.w3.org/2000/svg",
										width: "16",
										height: "16",
						...
						toc.length > 0 && /* @__PURE__ */ jsxs("div", {
							className: "bg-slate-50 border border-slate-200 rounded-xl p-6 mb-8 max-w-md",
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [post.authorImage && /* @__PURE__ */ jsx("img", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("div", {
											className: "flex flex-col sm:flex-row gap-4 sm:gap-8 mt-4 pt-4 border-t border-slate-100",
											children: [
										...
										post.authorSocials && (post.authorSocials.twitter || post.authorSocials.linkedin || post.authorSocials.website) && /* @__PURE__ */ jsxs("div", {
											...
											children: [
												post.authorSocials.twitter && /* @__PURE__ */ jsx("a", {
													...
													target: "_blank",
													rel: "nofollow noreferrer",
													className: "p-2 bg-slate-50 text-slate-500 hover:text-blue-500 rounded-full transition-colors",
													children: /* @__PURE__ */ jsx("svg", {
														xmlns: "http://www.w3.org/2000/svg",
														width: "16",
														height: "16",
												...
												post.authorSocials.linkedin && /* @__PURE__ */ jsx("a", {
													...
													target: "_blank",
													rel: "nofollow noreferrer",
													className: "p-2 bg-slate-50 text-slate-500 hover:text-blue-700 rounded-full transition-colors",
													children: /* @__PURE__ */ jsxs("svg", {
														xmlns: "http://www.w3.org/2000/svg",
														width: "16",
														height: "16",
												...
												post.authorSocials.website && /* @__PURE__ */ jsx("a", {
													...
													target: "_blank",
													rel: "nofollow noreferrer",
													className: "p-2 bg-slate-50 text-slate-500 hover:text-green-600 rounded-full transition-colors",
													children: /* @__PURE__ */ jsxs("svg", {
														xmlns: "http://www.w3.org/2000/svg",
														width: "16",
														height: "16",
						...
						/* @__PURE__ */ jsxs("div", {
							className: "mt-12 p-8 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 shadow-sm text-center",
							children: [
								/* @__PURE__ */ jsx("h3", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h3", {
							className: "text-xl font-bold mb-6 pb-2 border-b-2 border-blue-600 inline-block",
							...
							children: recentPosts && recentPosts.map((rp) => /* @__PURE__ */ jsxs(Link, {
								...
								className: "flex gap-4 group bg-white p-3 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all",
								children: [/* @__PURE__ */ jsx("div", {
									className: "relative w-24 h-20 shrink-0 rounded-lg overflow-hidden border border-slate-100 bg-slate-50",
									children: /* @__PURE__ */ jsx(Image, {
										src: rp.coverImage || "https://images.unsplash.com/photo-1542435503-956c469947f6?w=800&q=80",
										alt: rp.title,
										fill: true,
										style: { objectFit: "cover" },
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										className: "font-bold text-sm leading-tight text-slate-800 group-hover:text-blue-600 mt-1 line-clamp-3",
										children: rp.title
									})]
								})]
							}, rp.id))
