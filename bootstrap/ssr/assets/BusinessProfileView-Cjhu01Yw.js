...
import { AlertCircle, Building2, CheckCircle2, Clock, Edit3, FileText, Globe, Languages, Link2, MapPin, MessageSquare, Phone, Plus, Search, Share2, ShieldCheck, Sparkles, Star, ThumbsUp, TrendingUp, X } from "lucide-react";
...
var BusinessProfileView = ({ business, reviews, allBusinesses, onOpenWriteReview, onVoteHelpful, onAddReply }) => {
							...
							children: [
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx("img", {
														...
														children: [
															/* @__PURE__ */ jsx("span", { children: rev.reviewerLocation || "Sikar, Rajasthan" }),
															/* @__PURE__ */ jsx("span", { className: "w-1 h-1 rounded-full bg-slate-300 dark:bg-zinc-700" }),
															/* @__PURE__ */ jsx("span", { children: Number.isNaN(new Date(rev.createdAt).getTime()) ? rev.createdAt : new Date(rev.createdAt).toLocaleDateString("en-US", {
																year: "numeric",
																month: "short",
																day: "numeric"
															}) })
											...
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													className: "flex items-center gap-2",
													children: isOwner && /* @__PURE__ */ jsx("button", {
											...
											isOwner && replyingReviewId === rev.id && /* @__PURE__ */ jsxs("div", {
								...
								activeTab === "about" && /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										business.detailedDescription || business.detailed_description ? /* @__PURE__ */ jsx("div", {
											className: "prose dark:prose-invert max-w-none text-sm text-slate-600 dark:text-zinc-400",
											dangerouslySetInnerHTML: { __html: business.detailedDescription || business.detailed_description }
										}) : /* @__PURE__ */ jsx("p", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("h3", {
									...
									},
									{
										icon: Clock,
										label: "Hours",
										value: business.openingHours || business.opening_hours,
										color: "text-amber-500"
									}
								].filter((item) => item.value).map(({ icon: Icon, label, value, color }) => /* @__PURE__ */ jsxs("div", {
