...
var BusinessCard = ({ business, onSelectBusiness, onOpenWriteReview }) => {
	return /* @__PURE__ */ jsxs("article", {
		className: "bg-white dark:bg-zinc-900 rounded-xl overflow-hidden border border-slate-200 dark:border-zinc-800 shadow-sm hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col group",
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					className: "mt-auto pt-4 border-t border-slate-100 dark:border-zinc-800 space-y-2",
