...
function Contact() {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		post(route("page.contact.submit"), { onSuccess: () => {
			setSubmitted(true);
			reset();
		} });
	};
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs(Head, { children: [
				/* @__PURE__ */ jsx("title", { children: "Contact Us | CoachinginSikar" }),
				/* @__PURE__ */ jsx("meta", {
					name: "description",
					content: "Have a question about coaching or schools in Sikar? Reach out to the CoachingsinSikar team with suggestions, corrections, or topics you want us to cover next."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "keywords",
					content: "contact CoachingsinSikar, CoachingsinSikar contact, contact coaching guide Sikar, Sikar education contact, coaching information Sikar, education queries Sikar, coaching feedback Sikar"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:type",
					content: "website"
				...
				/* @__PURE__ */ jsx("meta", {
					property: "og:title",
					content: "Contact CoachingsinSikar - Helpline Number, Email, Location"
				}),
				/* @__PURE__ */ jsx("meta", {
					property: "og:description",
					content: "Questions, corrections, or ideas for new guides? Use this contact page to reach the CoachingsinSikar team and help us improve our coverage of coaching and schools in Sikar."
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:card",
				...
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:title",
					content: "Contact CoachingsinSikar"
				}),
				/* @__PURE__ */ jsx("meta", {
					name: "twitter:description",
					content: "Got a question about coaching or schools in Sikar? Send a message to the CoachingsinSikar team with your feedback, corrections, or topic suggestions."
				})
			] }),
			/* @__PURE__ */ jsx(Navbar, {}),
						...
						children: submitted ? /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", { children: [
									...
									errors.subject && /* @__PURE__ */ jsx("div", {
										className: "text-red-500 text-xs mt-1",
								...
								/* @__PURE__ */ jsxs("div", { children: [
									...
									errors.message && /* @__PURE__ */ jsx("div", {
										className: "text-red-500 text-xs mt-1",
								...
								/* @__PURE__ */ jsxs(AmberPillButton, {
									...
									disabled: processing,
									children: [/* @__PURE__ */ jsx(Send, { className: "w-4 h-4" }), processing ? "Sending..." : "Send Message"]
								})
							]
						})] })
					})]
