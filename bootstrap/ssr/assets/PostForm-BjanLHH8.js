import { t as MediaPicker } from "./MediaPicker-DhMqFL25.js";
...
function PostForm({ post }) {
	...
	const handleSave = async (published = true, isAutoSave = false) => {
		...
		startTransition(async () => {
			...
			const updatedPost = {
				...
				localBusiness,
				published,
				date: post?.date || format(/* @__PURE__ */ new Date(), "yyyy-MM-dd"),
				author: author || "Admin",
				factCheckedBy,
				factCheckerRole,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(AnimatePresence, { children: distractionFree && /* @__PURE__ */ jsx(motion.div, {
				initial: { opacity: 0 },
				animate: { opacity: 1 },
				exit: { opacity: 0 },
				...
				children: [/* @__PURE__ */ jsxs("main", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: /* @__PURE__ */ jsxs(AnimatePresence, {
							mode: "wait",
							children: [
								activeTab === "editor" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
								...
								activeTab === "snippets" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
								...
								activeTab === "eeat" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
								...
								activeTab === "schema" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
								...
								activeTab === "strategy" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
								...
								activeTab === "guardian" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
								...
								activeTab === "meta" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
								...
								activeTab === "seo" && /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										x: 20
									},
												...
												/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx("span", {
														...
														coverImage && coverImageWidth !== null && coverImageWidth < 1200 && /* @__PURE__ */ jsx("p", {
															...
															children: "Image is under 1200px wide. Google Discover requires ≥1200px width for premium layout cards."
														}),
			...
			/* @__PURE__ */ jsx(AnimatePresence, { children: sliderModalOpen && /* @__PURE__ */ jsx("div", {
				style: modalBackdropStyle,
				children: /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						scale: .9,
			...
			/* @__PURE__ */ jsx(AnimatePresence, { children: linkModalOpen && /* @__PURE__ */ jsx("div", {
				style: modalBackdropStyle,
				children: /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						scale: .9,
			...
			/* @__PURE__ */ jsx(AnimatePresence, { children: videoModalOpen && /* @__PURE__ */ jsx("div", {
				style: modalBackdropStyle,
				children: /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						scale: .9,
			...
			/* @__PURE__ */ jsx(AnimatePresence, { children: imageModalOpen && /* @__PURE__ */ jsx("div", {
				style: modalBackdropStyle,
				children: /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						scale: .9,
