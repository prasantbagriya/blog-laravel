      ...
      <div className="w-full max-w-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-md shadow-2xl p-6 sm:p-8 space-y-6 my-8">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-zinc-200 dark:border-zinc-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-zinc-900 dark:text-white">Gemini Semantic AI Search</h2>
              <p className="text-xs font-mono text-zinc-500 dark:text-zinc-400">Ask in natural language to find verified businesses</p>
            </div>
          </div>
        ...
        {results && (
          <div className="space-y-4 pt-2 border-t border-zinc-200 dark:border-zinc-800">
            <div className="p-4 rounded-sm bg-blue-100 dark:bg-blue-600/20 border border-blue-600/30 text-xs text-blue-600 dark:text-blue-400">
              <span className="font-bold font-mono block mb-1">AI Recommendation Insight:</span>
              <p className="leading-relaxed text-zinc-900 dark:text-zinc-100">{results.aiRecommendation}</p>
            </div>

            <div className="space-y-3">
              <span className="text-xs font-mono font-bold text-zinc-400 uppercase tracking-widest block">Matching Verified Businesses</span>
              {results.matches.map((biz) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="text-xs font-extrabold font-mono text-blue-600">{biz.trustScore}/100</div>
